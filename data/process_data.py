...
def load_data(messages_filepath, categories_filepath):
    """
    INPUT
    message_filepath - path to messages.csv file
    categories_filepath - path to categories.csv file
    
    OUTPUT
    df - Returns concatenated dataframe
    """
...
def clean_data(df):
    """
    INPUT
    df - Concatenated messages and categories dataset as dataframe
    OUTPUT
    df - Cleaned category values and de-duplicated data as dataframe
    """
